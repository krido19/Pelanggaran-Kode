        ...
        <div className="space-y-12 pb-12 bg-gray-50">
                ...
                <div className="container mx-auto px-4 relative z-10 pt-20">
                    <div className="max-w-2xl">
                        <p className="text-gray-500 text-lg mb-2 font-medium">
                            {localStorage.getItem('hero_subtitle') || "Platform Pelaporan"}
                        </p>
                        <h1 className="text-4xl md:text-6xl font-bold text-teal-800 leading-tight mb-6"
                            dangerouslySetInnerHTML={{ __html: localStorage.getItem('hero_title') || "Pelanggaran Kode Internasional<br />Pemasaran Pengganti ASI" }}
                        />
                        <div className="mb-8">
                        ...
                        <p className="text-gray-700 text-xl mb-10 leading-relaxed max-w-xl">
                            {localStorage.getItem('hero_desc') || "Mari bersama-sama melindungi anak-anak, ibu, keluarga dan kita semua dari praktik pemasaran susu formula dan semua produk pengganti ASI lainnya yang menyesatkan."}
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            >
                                {localStorage.getItem('hero_btn_primary') || "Laporkan Pelanggaran"}
                            </Link>
                            <Link
                                to="/about"
                            ...
                            >
                                {localStorage.getItem('hero_btn_secondary') || "Pelajari Selengkapnya"}
                            </Link>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-12">
                        ...
                        <div className="w-full md:w-2/3">
                            <h2 className="text-3xl font-bold text-teal-600 mb-6">
                                {localStorage.getItem('info1_title') || "What is International Code of Marketing of Breastmilk Substitutes?"}
                            </h2>
                            <div className="space-y-4 text-gray-600 leading-relaxed text-lg">
                                {(localStorage.getItem('info1_content') || "The Code is a global framework that regulates the marketing of breastmilk substitutes, issued by the World Health Organization in 1981 WHA (the World Health Assembly).\n\nAll WHO member state is recommended to adopt the Code into national legal instruments\n\nMeanwhile the baby food industry is required to comply with the Code").split('\n\n').map((paragraph, idx) => (
            ...
            <section className="py-16 bg-teal-50">
                <div className="container mx-auto px-4 text-center max-w-4xl">
                    <h2 className="text-2xl font-bold text-teal-700 mb-6">
                        {localStorage.getItem('info2_title') || "Why the Code is important?"}
                    </h2>
                    <div className="text-gray-700 leading-relaxed text-lg space-y-4">
                        {(localStorage.getItem('info2_content') || "The Code is issued as a response to the aggresive marketing of and the use of breastmilk substitutes which has led to infant mortality and morbidity\n\n* The Code applies with it subsequent WHA Resolutions").split('\n\n').map((paragraph, idx) => (
                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="mb-12 text-center">
                            <h2 className="text-3xl font-bold mb-4">
                                {localStorage.getItem('info3_title') || "WHA Resolutions Code"}
                            </h2>
                            <p className="text-teal-100 text-lg">
                                {localStorage.getItem('info3_subtitle') || "Relevant WHA resolutions are recommendations on the provisions of infant and young chil feeding. The subsequent WHA Resolutions are a response to the updated situation (of the unethical marketing of BMS)"}
                            </p>
                        </div>
            ...
            {showArticles && (
                <section className="container mx-auto px-4 py-16 bg-gray-50">
                    <h2 className="text-3xl font-bold text-teal-600 mb-12 text-center">Articles</h2>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-2xl py-16">
                        <p className="text-teal-600 font-medium mb-2 text-lg">
                            {localStorage.getItem('info4_subtitle') || "You can report"}
                        </p>
                        <h2 className="text-3xl md:text-5xl font-bold text-teal-800 mb-4 leading-tight">
                            {localStorage.getItem('info4_title') || "Violations of the International Code on Marketing of Breastmilk Substitutes"}
                        </h2>
                        <p className="text-gray-500 mb-8 text-xl font-medium">
                            {localStorage.getItem('info4_desc') || "Through the Chatbot"}
                        </p>
                        ...
                        <div className="mt-12 text-sm text-gray-500 max-w-md space-y-1">
                            <p className="font-bold text-teal-600">BOT 2024</p>
                            <p className="font-medium">by SSTEKNO</p>
                            <p className="leading-relaxed opacity-80 pt-2">
                                Your report will be verified then documented. We will forward your report to local government as well as submit it to the annual WHA for further follow up. All information you provided is kept confidential
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="relative h-[600px] bg-gray-100">
                ...
                <div className="absolute top-0 left-0 right-0 z-10 grid grid-cols-4 text-white">
                    ...
                    <div className="bg-teal-400 p-6 text-center">
                        ...
                        <p className="text-sm font-medium">Total Laporan Masuk</p>
                    </div>
                </div>
            ...
            {showSupporters && (
                <section className="bg-teal-50 py-16">
                    <div className="container mx-auto px-4 text-center">
                        <h2 className="text-2xl font-bold text-teal-700 mb-12">Didukung oleh</h2>
