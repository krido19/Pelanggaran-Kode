            ...
            <div className="container mx-auto px-4 h-[calc(100vh-100px)] min-h-[800px]">
                <div className="mb-6">
                    <h1 className="text-3xl font-bold text-gray-800">
                        {getLocalizedContent('stats_page_title', "Data & Statistik")}
                    </h1>
                    <p className="text-gray-600">
                        {getLocalizedContent('stats_page_desc', "Pantau sebaran dan data pelanggaran kode etik pemasaran produk pengganti ASI.")}
                    </p>
                </div>
                    ...
                    <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex flex-col">
                        <div className="p-4 border-b border-gray-100 flex justify-between items-center">
                            <h2 className="text-xl font-bold text-gray-800">
                                {getLocalizedContent('stats_map_title', "Peta Sebaran")}
                            </h2>
